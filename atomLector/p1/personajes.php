...
<div class="card col-md-12">
 ...
 <input style="<?php echo $bntTerminarQuiz; ?>margin-top: 20px; margin-bottom: 50px; border:1px solid #2980b9; background-color: #2980b9; color:white;" onclick="obtenerTiempoSubmit();"  value="Termine el cuestionario" name="" class="btn btn-default botonAgg-1">
  </form>
